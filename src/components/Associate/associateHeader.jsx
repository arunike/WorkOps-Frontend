...
const AssociateHeader = ({ handleBack, updateBackendAndState }) => {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:8081/associates/${associateData.id}/password`, {
        method: "PUT",
                        ...
                        <CardContent>
                          ...
                          >
                            <Grid item>
                              ...
                              {associateData.PostalAddress?.City || associateData.Office}
                            </Grid>
                            <Grid item sx={{ pt: 2 }}>
                              <p>{associateData.StartDate && associateData.StartDate.toDate ? DateDifferenceCheck() : "No Start Date"}</p>
                            </Grid>
                            {/* Icons */}
                            <Grid item>
                              <Grid
                              ...
                              >
                                <Grid item xs={6}>
                                  <Link
                                    target="_blank"
                                    href={`https://teams.microsoft.com/l/chat/0/0?users=${associateData.WorkEmail || associateData.Email}`}
                                  >
                                    <Icon
                                      icon={microsoftTeams}
                                      width="30"
                                ...
                                <Grid item xs={6}>
                                  <Link
                                    href={`mailto:${associateData.WorkEmail || associateData.Email}`}
                                  >
                      ...
                      <Grid item xs={12} md={1} lg={1} mt={2}>
                        ...
                        >
                          ...
                          <MenuItem
                            ...
                            disableRipple
                          >
                            <Icon icon="mdi:lock-reset" width="20" height="20" style={{ marginRight: 8, color: '#637381' }} />
                            Change Password
                          </MenuItem>
                        </StyledMenu>
                      </Grid>
        ...
        <Dialog open={openPasswordDialog} onClose={() => setOpenPasswordDialog(false)}>
          ...
          <DialogContent>
            <DialogContentText sx={{ mb: 2 }}>
              Enter a new password for this associate.
            </DialogContentText>
            <TextField
              autoFocus
              margin="dense"
        ...
        <Grid item xs={12} md={6} lg={9}>
          <Card>
            <TabPanel value={value} index={0}>
              <AssociateInfo updateBackendAndState={updateBackendAndState} />
            </TabPanel>
            ...
            <TabPanel value={value} index={2}>
              <AssociateNotes updateBackendAndState={updateBackendAndState} />
            </TabPanel>
